...
<template>
    <div class="title-bar">
        <div class="title-bar-dragger"> <el-image class="logo" src="favicon.ico" fit="cover"></el-image>
            <span>异世界转生模拟器</span>
        </div>
    ...
    <div class="header">
        <v-btn append-icon="mdi-plus-circle-multiple-outline" variant="text" to="/donate">投食</v-btn>
    </div>
</template>
<script lang='ts'>
